            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right" data-aos-anchor="[data-aos-id-features-home]">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <h3 className="h3 mb-3">Essay Generation By STEK</h3>
                  <p className="text-xl text-gray-400 mb-4">Essay generator by STEK uses the state of the art essay geneartion technolgies. The users will be able to freely generate
                    thier preefered essay draft by simply inputing the essay topic they require.</p>
                  <ul className="flex flex-wrap text-lg text-gray-400 -mx-2 -my-1">
                    ...
                    <li className="flex items-center mx-2 my-1">
                      ...
                      <span>Accurate Essay Drafts</span>
                    </li>
                    <li className="flex items-center mx-2 my-1">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                  ...
                  <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
                    <div data-aos="fade-up" data-aos-delay="400">
                      <a className="btn text-white bg-purple-600 hover:bg-purple-700 w-full mb-4 sm:w-auto sm:mb-0" href="/get-essay-topic">Generate Essay Draft</a>
                    </div>
