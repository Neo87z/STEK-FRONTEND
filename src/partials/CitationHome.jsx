            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right" data-aos-anchor="[data-aos-id-features-home]">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <h3 className="h3 mb-3">Citation Genearator By STEK</h3>
                  <p className="text-xl text-gray-400 mb-4">Citaion Generator offered by STEK provides the user the best and the fasts citations for any research material. It is free to use and easy to use </p>
                ...
                <br></br>
                  <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
                    <div data-aos="fade-up" data-aos-delay="400">
                      <a className="btn text-white bg-purple-600 hover:bg-purple-700 w-full mb-4 sm:w-auto sm:mb-0" href="/citation-data">Use Citation Generator</a>
                    </div>
